...
void Laser::init(int dac_cs_pin, int dac_latch_pin, int dac_mosi_pin, int dac_clk_pin)
{
  dac.init(MCP4X_4822, 5000, 5000,
      dac_cs_pin, dac_latch_pin, 1);
  dac.setGain2x(MCP4X_CHAN_A, 0);
  dac.setGain2x(MCP4X_CHAN_B, 0);
  dac.begin(1, dac_clk_pin, -1, dac_mosi_pin, dac_cs_pin);
